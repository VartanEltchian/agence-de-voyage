...
public class CalendarView {
    ...
    private Reservat reserv;
    
    
 
    public Reservat getReserv() {
		return reserv;
	}

	public void setReserv(Reservat reserv) {
		this.reserv = reserv;
	}
    ...
    public void nbjoursselec (List rangecal)
	{
    	
    	
		nbjours=rangecal.size();
		
		reserv.setNbjours(nbjours);
